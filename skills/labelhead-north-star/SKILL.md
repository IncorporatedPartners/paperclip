...
**Supersedes:** Version 2.0 (June 2026), Version 1.0 (March 2026)
...
**TIER 1 — Daily Competition**
- Prize: $500/day
- Winner: Highest single-day aggregate score across Founding Season competitors
- Season total (84 days): $42,000
- Funded by: Sovereign operating budget

**TIER 2 — Weekly Cycle Competition**
...
| **Daily Competition** | Founding Season | ✅ Canonical | $500/day, 9-10:30 AM ET window |
...
- ✅ Scoring components: 3 Momentum + A&R Alpha modifier + Motion Score output
...
- [ ] Exact weighting of Acceleration, Longevity, Cultural Gravity within Momentum Score
- [ ] Whether A&R Alpha is ever surfaced to artists in simplified form
- [ ] Motion Score trademark clearance confirmation
- [ ] Precise A&R Alpha formula parameters (ownership curve shape, timing decay function)
...
Version 3.0 supersedes all prior versions across all instances.
